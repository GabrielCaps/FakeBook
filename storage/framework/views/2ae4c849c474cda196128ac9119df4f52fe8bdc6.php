...
<div class="col-lg-9 mt-3 fs-5 overflow-auto row justify-content-center">
	<div class="container-fluid">
		<form class="row bg-white shadow rounded p-4" action="<?php echo e(route ('post.create')); ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
			<?php echo csrf_field(); ?>
			<input class="placeholder border-1 col-md-12 rounded-pill shadow bg-white mt-1 p-2" type="text" name="content" placeholder="Escreva o que quiser!">
			<div class="col-md-6">
...
fileChooser.onchange = e => {
    ...
    reader.readAsDataURL(fileToUpload);
			...
			<div class="d-flex justify-content-center">
				<button class="shadow col-md-4 btn btn-primary mt-2" type="submit">Publicar</button>
			</div>
		</form>
		<?php if(session('msg')): ?>
		 	<div class="row">
	...
	<div class="shadow col-lg-9 col-md-12 row fs-5 mt-5 p-0 bg-white rounded">
	 					...
	 					<?php if(Auth::user()->id == $Post->user_id): ?>
							...
							<div class="col-3">
								<form action="<?php echo e(route('post.destroy', ['id' => $Post->id])); ?>" method="POST">
						    		...
						    		<button class="placeholder-sm bg-white border rounded-pill shadow w-100 mb-2">Apagar</button>		    		
						    	</form>
						    	<button class="placeholder-sm bg-white border rounded-pill shadow w-100" data-bs-toggle="modal" data-bs-target="#exampleModal-<?php echo e($Post->id); ?>" data-bs-whatever="@mdo">Editar</button>
							</div>
			...
			<?php endif; ?>
				<div class="col-md-12 row mb-2">
					<button class="border-0 col bg-white pb-2 placeholder-sm"><i class="bi bi-heart"></i> Amei</button>
					<button class="border-0 col bg-white pb-2 placeholder-sm"><i class="bi bi-share-fill"></i> Compartilhar</button>		
				</div>
				...
				<div class="background-comment rounded p-2 border">
					...
					<form action="<?php echo e(route ('comment.create')); ?>" method="POST">
						...
						<input class="placeholder p-1 rounded-pill shadow bg-white col-12" type="text" name="content" placeholder="Comente!">
					</form>
								  ...
								  <div class="modal-dialog modal-dialog-centered">
								    <div class="modal-content">
								      <div class="modal-header">
								        <h5 class="modal-title" id="exampleModalLabel">Editar conteúdo</h5>
								        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
								      </div>
								      <div class="modal-body">
								        <form class="row bg-white rounded p-4" action="<?php echo e(route ('post.edit', ['id' => $Post->id])); ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
											<?php echo csrf_field(); ?>
											<input class="border-1 col-md-12 rounded-pill bg-white mt-1 p-1" type="text" name="content" placeholder="Editar conteúdo">
											<div class="col-md-6">
											...
											<div class="row mt-1 justify-content-around">
										        ...
										        <button type="submit" class="btn btn-primary col-md-4">Confirmar</button>
										    </div>
										</form>
								      </div>
								    </div>
												    ...
												    <div class="row vh-100">
												    	<div class="col-lg-9 d-flex align-items-center justify-content-center bg-dark p-0 mh-100">
											    			...
											    			<img class="mw-100 mh-100" src="/storage/app/<?php echo e($Post->image); ?>">
											    				<?php else: ?>
											    				<h1 class="text-white">Sem foto</h1>
											    			<?php endif; ?>
												    	</div>
												    	<div class="col-lg-3 col-md-12 d-flex flex-column">
														    			...
														    			<?php if(Auth::user()->id == $Comment->user_id): ?>
																			<div class="d-flex">
																				<form action="<?php echo e(route('comment.destroy', ['id' => $Comment->id])); ?>" method="POST">
																		    		<?php echo csrf_field(); ?>
																		    		<?php echo method_field('DELETE'); ?>
																		    		<button class="placeholder-sm border-0 bg-transparent p-1 m-0" type="submit">Apagar</button>	
																		    	</form>
																			    
																			    <button class="placeholder-sm border-0 bg-transparent p-1 ms-2 mt-0" data-bs-toggle="modal" data-bs-target="#commentModal-<?php echo e($Comment->id); ?>" data-bs-whatever="@mdo">Editar</button>	
																			</div>
																		<?php endif; ?>
																</div>
												    		...
												    		<footer class="modal-footer d-flex justify-content-center">
												    			<form action="<?php echo e(route ('comment.create')); ?>" method="POST">
												    				<?php echo csrf_field(); ?>
												    				<input type="hidden" name="post_id" value="<?php echo e($Post->id); ?>">
												    				<input class="mb-2 rounded-pill shadow bg-white w-100 p-2 placeholder" type="text" name="mb-1 content" placeholder="Comente!">
												    			    <button type="button" class="btn btn-primary col-none-lg w-100 mt-2 rounded-pill" data-bs-dismiss="modal" aria-label="Close">Fechar</button>
												    			</form>
												    		</footer>
												    	</div>
												    </div>
								...
								<div class="modal fade" id="commentModal-<?php echo e($Comment->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
								  ...
								  <div class="modal-dialog modal-dialog-centered">
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								        <form class="row bg-white rounded p-4" action="<?php echo e(route ('comment.edit', ['id' => $Comment->id])); ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
											<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gabriel/Área de Trabalho/Treino2/resources/views/dashboard.blade.php ENDPATH**/ ?>