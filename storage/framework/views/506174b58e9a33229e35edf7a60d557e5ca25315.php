...
<div class="col-lg-9 mt-3 fs-5 overflow-auto row justify-content-center">
	<div class="row">
		<div class="col-md-12 d-flex">
			<div>
				<img class="mainPerfil shadow rounded-circle border border-2 me-4" src="<?php echo e(asset('img/No_photo.png')); ?>" alt="Foto de perfil">
			</div>
			<div class="fs-2 mt-3"><h1 class="placeholder-sm"><?php echo e($Users->name); ?></h1></div>
		</div>
	</div>
	 					...
	 					<?php if(Auth::user()->id == $Post->user_id): ?>
							...
							<div class="col-3">
								<form action="<?php echo e(route('post.destroy', ['id' => $Post->id], app()->getLocale())); ?>" method="POST">
						    		...
						    		<button class="placeholder-sm bg-white border rounded-pill shadow w-100 mb-2" type="submit"><?php echo e(__ ('Delete')); ?></button>
						    	</form>
...
<?php echo $__env->make('layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gabriel/Área de Trabalho/Treino/resources/views/dashboard/profile.blade.php ENDPATH**/ ?>